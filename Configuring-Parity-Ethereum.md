...
cors = []
hosts = ["none"]
apis = ["web3","eth","pubsub","net","parity","private","parity_pubsub","traces","rpc","shh","shh_pubsub","parity_transactions_pool"]
server_threads = 1
...
hosts = ["none"]
apis = ["web3","eth","pubsub","net","parity","parity_pubsub","private","traces","rpc","shh","shh_pubsub","parity_transactions_pool"]
max_connections = 100

[ipc]
disable = false
path = $HOME/.local/share/io.parity.ethereum/jsonrpc.ipc
apis = ["web3","eth","pubsub","net","parity","parity_pubsub","parity_accounts","private","traces","rpc","shh","shh_pubsub","parity_transactions_pool"]
...
```
#### Default Value 
`web3,eth,pubsub,net,parity,private,parity_pubsub,traces,rpc,shh,shh_pubsub,parity_transactions_pool`
...
```
#### Default Value 
`web3,eth,pubsub,net,parity,parity_pubsub,private,traces,rpc,shh,shh_pubsub,parity_transactions_pool`
...
```
#### Default Value 
`web3,eth,pubsub,net,parity,parity_pubsub,parity_accounts,private,traces,rpc,shh,shh_pubsub,parity_transactions_pool`
