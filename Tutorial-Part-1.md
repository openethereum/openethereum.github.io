...
Once you have it linked, you should start (or restart, if already running) Parity and head to the Applications page of Parity Wallet. There you'll see your new dapp (_Note: If you are not running `npm start` in parity/src/js to have a development instance your URL is likely **localhost:8180** _):
