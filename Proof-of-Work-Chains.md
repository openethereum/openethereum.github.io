---
title: Proof-of-Work Chains
---

Here is an example chain specification file for a public/open Proof-of-Work (Ethash) chain. To start OpenEthereum with a JSON file specifying the chain, run `$ openethereum --chain path/to/chain/spec.json`, or create a [config file](Configuring-OpenEthereum#config-file):
